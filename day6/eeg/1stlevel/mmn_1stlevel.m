function mmn_1stlevel(id, options)
%mmn_1STLEVEL Computes the first level contrast images for modelbased
%statistics for one subject from the mmn study.
...
mmn_display_analysis_step_header('firstlevel stats', id, options.stats);
