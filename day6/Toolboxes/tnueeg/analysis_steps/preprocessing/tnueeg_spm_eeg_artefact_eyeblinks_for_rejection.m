function res = tnueeg_spm_eeg_artefact_eyeblinks_for_rejection(S)
%TNUEEG_SPM_EEG_ARTEFACT_EYEBLINKS_FOR_REJECTION Modified SPM function:
...
% large blinks ( > mean + 1 s.d.) because they'll anyway be rejected
