function c = tapas_bayes_optimal_transition_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% Usage:
%     fitModel([], inputs, '<perceptual_model>', 'bayes_optimal_transition_config', ...)
% 
...
% Model name
c.model = 'Bayes optimal transition';
...
% Model filehandle
c.obs_fun = @tapas_bayes_optimal_transition;

% This is the handle to a dummy function since there are no parameters to transform
c.transp_obs_fun = @tapas_bayes_optimal_transition_transp;
