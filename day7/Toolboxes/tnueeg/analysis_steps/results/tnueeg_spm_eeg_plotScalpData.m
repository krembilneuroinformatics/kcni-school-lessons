function [ZI,f] = tnueeg_spm_eeg_plotScalpData(Z,pos,ChanLabel,in)
%TNUEEG_SPM_EEG_PLOTSCALPDATA Display M/EEG interpolated sensor data on a 
%scalp image
% Modified SPM function. 
...
% By default, plot the channel labels (visible: on), ll. 157-59
